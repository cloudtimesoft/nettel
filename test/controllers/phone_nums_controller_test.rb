...
class PhoneNumsControllerTest < ActionController::TestCase
  ...
  test "should create phone_num" do
    assert_difference('PhoneNum.count') do
      post :create, phone_num: { attribution: @phone_num.attribution, contact_id: @phone_num.contact_id, is_primary: @phone_num.is_primary, operator: @phone_num.operator, type: @phone_num.type }
    end
  ...
  test "should update phone_num" do
    patch :update, id: @phone_num, phone_num: { attribution: @phone_num.attribution, contact_id: @phone_num.contact_id, is_primary: @phone_num.is_primary, operator: @phone_num.operator, type: @phone_num.type }
    assert_redirected_to phone_num_path(assigns(:phone_num))
  end
